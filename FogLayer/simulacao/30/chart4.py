...
def main(args=None):
    ...
    res = pd.concat([df1_select], sort=False)
...
if __name__ == "__main__":
    ...
    # comando 
    # /usr/bin/python3 chart4.py -n colonia.net.xml --xlim 50,600 --ylim 100,620 --selected-width 0.5 --edge-width 0.5 --edge-color '#909DA3' --selected-color '#7fffff' -o mapa_30_baseline.png
    #